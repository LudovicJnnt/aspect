...
{\it Value:} $ASPECT_SOURCE_DIR/data/boundary-velocity/ascii-data/test/


{\it Default:} $ASPECT_SOURCE_DIR/data/boundary-velocity/ascii-data/test/
...
{\it Value:} $ASPECT_SOURCE_DIR/data/boundary-velocity/gplates/


{\it Default:} $ASPECT_SOURCE_DIR/data/boundary-velocity/gplates/
...
{\it Value:} $ASPECT_SOURCE_DIR/data/gravity-model/


{\it Default:} $ASPECT_SOURCE_DIR/data/gravity-model/
...
{\it Value:} $ASPECT_SOURCE_DIR/data/initial-composition/ascii-data/test/


{\it Default:} $ASPECT_SOURCE_DIR/data/initial-composition/ascii-data/test/
...
{\it Value:} $ASPECT_SOURCE_DIR/data/initial-temperature/adiabatic-boundary/


{\it Default:} $ASPECT_SOURCE_DIR/data/initial-temperature/adiabatic-boundary/
...
{\it Value:} $ASPECT_SOURCE_DIR/data/initial-temperature/ascii-data/test/


{\it Default:} $ASPECT_SOURCE_DIR/data/initial-temperature/ascii-data/test/
...
{\it Value:} $ASPECT_SOURCE_DIR/data/initial-temperature/S40RTS/


{\it Default:} $ASPECT_SOURCE_DIR/data/initial-temperature/S40RTS/
...
{\it Value:} $ASPECT_SOURCE_DIR/data/initial-temperature/SAVANI/


{\it Default:} $ASPECT_SOURCE_DIR/data/initial-temperature/SAVANI/
...
{\it Value:} visualization, gravity calculation
...
{\it Possible values:} A comma-separated list of any of Stokes residual, basic statistics, boundary densities, boundary pressures, command, composition statistics, core statistics, depth average, dynamic topography, geoid, global statistics, gravity calculation, heat flux densities, heat flux map, heat flux statistics, heating statistics, mass flux statistics, matrix statistics, melt statistics, memory statistics, particle count statistics, particles, point values, pressure statistics, spherical velocity statistics, temperature statistics, topography, velocity boundary statistics, velocity statistics, visualization
