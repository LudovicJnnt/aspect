      ...
      if (compositional_index == crust1_index)
        {
          ...
          std::array<double,dim> scoord = Utilities::Coordinates::WGS84_coordinates(position);
